...
import { Flex, Heading, TextField, View, SwitchField, Button } from "@aws-amplify/ui-react";
import { API } from "aws-amplify";
import { createMember as createMemberMutation } from "../graphql/mutations";
...
const MemberCreate = (props) => {
    ...
    const [streetAddress, setStreetAddress] = React.useState(initialValues.streetAddress);
    ...
    const [emailAddress, setEmailAddress] = React.useState(initialValues.emailAddress);
    const [mailingList, setMailingList] = React.useState(initialValues.mailingList);
    const [newsletter, setNewsletter] = React.useState(initialValues.newsletter);
    const [medFormDate, setMedFormDate] = React.useState(initialValues.medFormDate);
    const [emergencyContact1, setEmergencyContact1] = React.useState(initialValues.emergencyContact1);
    const [emergencyContact1Phone, setEmergencyContact1Phone] = React.useState(initialValues.emergencyContact1Phone);
    const [emergencyContact2, setEmergencyContact2] = React.useState(initialValues.emergencyContact2);
    const [emergencyContact2Phone, setEmergencyContact2Phone] = React.useState(initialValues.emergencyContact2Phone);
    ...
    async function createMember(event){
        ...
        const data = {
            ...
            medFormDate: (medFormDate === ""? null : medFormDate),
            emergencyContact1: emergencyContact1,
            emergencyContact1Phone: (emergencyContact1Phone === ""? null : emergencyContact1Phone),
            emergencyContact2: emergencyContact2,
            emergencyContact2Phone: (emergencyContact2Phone === ""? null : emergencyContact2Phone),
        };
        await API.graphql({
    ...
    return (
        <PageBody>
            <View className="MemberCreate">
                <Heading level={1}>Create New Member</Heading>
