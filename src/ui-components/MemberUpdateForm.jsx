...
export default function MemberUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setBsaId(cleanValues.bsaId);
    setActive(cleanValues.active);
    setStreetAddress(cleanValues.streetAddress);
    setCity(cleanValues.city);
    setState(cleanValues.state);
    setZipCode(cleanValues.zipCode);
    setHomePhone(cleanValues.homePhone);
    setWorkPhone(cleanValues.workPhone);
    setCellPhone(cleanValues.cellPhone);
    setEmailAddress(cleanValues.emailAddress);
    setMailingList(cleanValues.mailingList);
    setNewsletter(cleanValues.newsletter);
    setMedFormDate(cleanValues.medFormDate);
    setEmergencyContact1(cleanValues.emergencyContact1);
    setEmergencyContact1Phone(cleanValues.emergencyContact1Phone);
    setEmergencyContact2(cleanValues.emergencyContact2);
    setEmergencyContact2Phone(cleanValues.emergencyContact2Phone);
    setErrors({});
  };
